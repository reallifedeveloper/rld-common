 ...
 * <p>
 * An implementation of this interface normally uses a messaging system to publish messages containing
 * information about the notifications. In this case, the <i>publicationChannel</i> that is used by the
 * {@link #publish(List, String)} method would correspond to an exchange name.
 *
...
public interface NotificationPublisher {
     ...
     *
     * @param notifications a list of <code>Notifications</code> to publish
